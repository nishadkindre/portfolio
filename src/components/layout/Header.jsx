    ...
    >
      <nav className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Button href="/Nishad_Kindre_Developer_Resume_2026.pdf" variant="primary" size="sm" className="ml-2">
            Resume
          </Button>
        </div>
      ...
      >
        ...
        <div className="flex flex-col items-start justify-center h-full px-10 gap-8">
          ...
          <Button href="/Nishad_Kindre_Developer_Resume_2026.pdf" variant="primary" className="mt-4">
            Resume
          </Button>
        </div>
      </div>
